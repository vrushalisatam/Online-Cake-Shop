        ...
        <center>
            <div class="container">
                <form method="post" action="controller.jsp">
                    <input type="hidden" name="page" value="login1">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="1">
                                <br>
                                <button type="submit" class="loginbtn" style="margin-left: 10px"  onclick=" return confirm('Your Order Has Been Confirmed!!');">Login</button>
                            </td>
                        </tr>
                    </table>
